...
public class Tank {
	...
	static {
		tankImgs = new Image[] {
				tk.getImage(Tank.class.getClassLoader().getResource("imgs/tankD.png")),
				tk.getImage(Tank.class.getClassLoader().getResource("imgs/tankL.png")),
				tk.getImage(Tank.class.getClassLoader().getResource("imgs/tankLD.png")),
				tk.getImage(Tank.class.getClassLoader().getResource("imgs/tankLU.png")),
				tk.getImage(Tank.class.getClassLoader().getResource("imgs/tankR.png")),
				tk.getImage(Tank.class.getClassLoader().getResource("imgs/tankRD.png")),
				tk.getImage(Tank.class.getClassLoader().getResource("imgs/tankRU.png")),
				tk.getImage(Tank.class.getClassLoader().getResource("imgs/tankU.png")),
