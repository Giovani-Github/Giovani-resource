...
public class Missile {	
	...
	static {
		tankImgs = new Image[] {
				tk.getImage(Tank.class.getClassLoader().getResource("imgs/missileU.png")),
				tk.getImage(Tank.class.getClassLoader().getResource("imgs/missileL.png")),
				tk.getImage(Tank.class.getClassLoader().getResource("imgs/missileLD.png")),
				tk.getImage(Tank.class.getClassLoader().getResource("imgs/missileLU.png")),
				tk.getImage(Tank.class.getClassLoader().getResource("imgs/missileR.png")),
				tk.getImage(Tank.class.getClassLoader().getResource("imgs/missileRD.png")),
				tk.getImage(Tank.class.getClassLoader().getResource("imgs/missileRU.png")),
				tk.getImage(Tank.class.getClassLoader().getResource("imgs/missileD.png")),
