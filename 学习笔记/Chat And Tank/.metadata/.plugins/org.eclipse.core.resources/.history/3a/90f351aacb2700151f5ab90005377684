...
public class Tank {	
	...
	public Missile fire() {
		...
		Missile m = new Missile(id, x, y, good, ptDir, this.tc);//根据炮筒的方向开火
		tc.missiles.add(m);
