...
public class Missile {	
	...
	static {
		tankImgs = new Image[] {
				tk.getImage(Tank.class.getClassLoader().getResource("imgs/missileD.gif")),
				tk.getImage(Tank.class.getClassLoader().getResource("imgs/missileL.gif")),
				tk.getImage(Tank.class.getClassLoader().getResource("imgs/missileLD.gif")),
				tk.getImage(Tank.class.getClassLoader().getResource("imgs/missileLU.gif")),
				tk.getImage(Tank.class.getClassLoader().getResource("imgs/missileR.gif")),
				tk.getImage(Tank.class.getClassLoader().getResource("imgs/missileRD.gif")),
				tk.getImage(Tank.class.getClassLoader().getResource("imgs/missileRU.gif")),
				tk.getImage(Tank.class.getClassLoader().getResource("imgs/missileU.gif")),
