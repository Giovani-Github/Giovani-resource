...
public class MyContentProvider extends ContentProvider {
	...
	static {
		 ...
		 */
		// 用户传入的uri：content://com.example.mycontentprovider2/person，与这条匹配
		um.addURI("com.example.mycontentprovider2", "person", 1); 
		// 用户传入的uri：content://com.example.mycontentprovider2/person2，与这条匹配
		um.addURI("com.example.mycontentprovider2", "person2", 2);
	}
