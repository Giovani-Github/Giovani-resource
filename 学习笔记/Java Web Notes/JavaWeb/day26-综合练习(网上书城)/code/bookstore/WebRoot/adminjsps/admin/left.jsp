...
function load() {
	...
	*/
	...
	bar1.add("订单管理", "未付款订单", "<c:url value='/admin/AdminOrderServlet?method=toOrderByState&state=1'/>", "body");
	bar1.add("订单管理", "已付款订单", "<c:url value='/admin/AdminOrderServlet?method=toOrderByState&state=2'/>", "body");
	bar1.add("订单管理", "未收货订单", "<c:url value='/admin/AdminOrderServlet?method=toOrderByState&state=3'/>", "body");
	bar1.add("订单管理", "已完成订单", "<c:url value='/admin/AdminOrderServlet?method=toOrderByState&state=4'/>", "body");
